...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String stEmail = in.getStringExtra("email");
        setTitle(stEmail);
        ...
        btnSend.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view){
                ...
                if(stText.equals("") || stText.isEmpty())
                {
                    ...
                    DatabaseReference myRef = database.getReference("users").child(stChatId).child("ChatRoom").child(stChatId+", "+userUid).child("chats").child(formattedDate);
                    DatabaseReference myRef2 = database.getReference("users").child(userUid).child("ChatRoom").child(userUid+", "+stChatId).child("chats").child(formattedDate);;
        ...
        DatabaseReference myRef = database.getReference("users").child(stChatId).child("ChatRoom").child(stChatId+", "+userUid).child("chats");
