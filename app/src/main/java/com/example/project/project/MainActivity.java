                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            Hashtable<String, String> CurentUser = new Hashtable<String, String>();
                            CurentUser.put("email", userEmail);
                            CurentUser.put("Uid", userUid);
                            myRef.setValue(CurentUser);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            //Intent in = new Intent(MainActivity.this, testpage.class);
                            startActivity(in);
